...
| Общее состояние | [##########################>-----------------------] 53.45% | Уточнение состояния |
|:--|:--|:--|
...
| Основы маршрутизации|[---------------------------------------------------] 0% | Пустая страница... |
| Основы контроллера|[---------------------------------------------------] 0% | Пустая страница... |
...
| Приложение: Scotch Box|[################################################>-] 97% | Обработка перевода... |
